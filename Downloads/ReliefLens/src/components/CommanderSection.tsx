...
export const CommanderSection: React.FC<CommanderSectionProps> = ({
  ...
  return (
    <section id="commander" className="w-full max-w-6xl mx-auto px-4 py-16 scroll-mt-20">
      ...
      {/* Map + Queue Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 h-[600px]">
        
        {/* Right Side (35%): Priority Queue */}
        <div className="lg:col-span-2 lg:order-2 bg-[#0D1117] border border-white/[0.06] rounded-2xl p-4 flex flex-col gap-3 h-full overflow-hidden">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-[10px] text-[#8BA3C7]">
                        ...
                        <span className={`uppercase font-bold px-1.5 rounded-md ${
                          inc.severity === 'critical' ? 'bg-red-500/15 text-red-400' : 'text-[#8BA3C7]'
                        }`}>
                          {inc.severity}
                        </span>
                      </div>
        ...
        <div className="lg:col-span-3 lg:order-1 rounded-2xl overflow-hidden border border-white/[0.06] bg-[#050810] relative h-full">
                ...
                >
                  <Popup>
                    <div className="p-2 bg-[#0D1117] text-[#E8F4FD] text-xs flex flex-col gap-1 rounded-lg min-w-[160px]">
                      ...
                      <span className="text-[10px] text-[#8BA3C7] max-w-[180px] truncate">
                        {inc.where?.description}
                      </span>
                    </div>
                  </Popup>
                </CircleMarker>
          ...
          <div className="absolute bottom-3 right-3 z-[400] pointer-events-none">
            <div className="px-3 py-1.5 bg-[#050810]/80 backdrop-blur-md border border-white/[0.08] rounded-full text-[10px] text-[#8BA3C7] font-medium">
              📍 Live Geo-Targeting
            </div>
          </div>
